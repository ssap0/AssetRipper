...
`en_US.json` is expected to be in alphabetical order because it's human-written. The rest of the files are generated by Weblate, so they might not be in alphabetical order.
